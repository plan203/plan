    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <main className="container mx-auto px-6 py-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          {/* Features Grid */}
          <div className={`${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-100'} rounded-2xl shadow-lg p-8 border mb-12`}>
            <div className="text-center">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Continuous Improvement</h3>
              <p className="text-gray-600 leading-relaxed">
                We are constantly working to enhance our site and provide the best experience for our users. 
                Your feedback is invaluable to us—please share any suggestions or input. We carefully implement 
                improvements to ensure they are reliable and free of issues.
              </p>
            </div>
          </div>
